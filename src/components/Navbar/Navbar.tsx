...
const NavTop = () => (
  <div className="bg-gray-100/50 dark:bg-gray-900 text-[11px] text-gray-500 dark:text-gray-400 py-1 hidden md:block border-b border-transparent dark:border-gray-800">
...
const NavCenter = () => (
  <div className="container mx-auto px-4 py-3 md:py-4 flex items-center gap-4 md:gap-8 bg-white dark:bg-gray-900 z-20 relative transition-colors duration-300">
    ...
    <div className="flex-1 relative group z-50">
      <div className="relative">
        <input 
          ...
          className="w-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-100 rounded-lg py-2.5 px-4 pl-10 focus:outline-none focus:border-primary focus:ring-2 focus:ring-green-100 dark:focus:ring-green-900/30 focus:bg-white dark:focus:bg-gray-900 transition-all shadow-sm" 
        />
    ...
    <div className="flex items-center gap-3 md:gap-6">
      ...
      {/* Theme Switcher ditambahkan di sini */}
      <ThemeSwitcher />
...
export default function Navbar() {
  ...
  return (
    <header className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-sm fixed w-full top-0 z-50 transition-all duration-300 border-b border-gray-100 dark:border-gray-800" id="navbar">
      <NavTop />
      <NavCenter />
