  ...
  return (
    ...
    >
      <div className="sticky top-[170px]">
        <div className="rounded-lg overflow-hidden border border-gray-100 dark:border-gray-800 mb-3 relative group bg-white dark:bg-gray-900">
          <img
            src={activeImg}
            className="w-full aspect-square object-contain transition-transform duration-500 group-hover:scale-105 cursor-zoom-in"
            alt="Product"
          />
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
          {images.map((img, idx) => (
            <button
              ...
              className={`w-16 h-16 rounded border-2 cursor-pointer overflow-hidden flex-shrink-0 ${
                activeImg === img
                  ? "border-primary"
